					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="webdesign2" role="tabpanel" aria-labelledby="webdesign-tab2">
							<div class="gallery text-center row">
								...
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/2.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/2_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/3.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/3_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/4.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/4_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/5.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/5_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/6.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/6_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/7.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/7_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/8.jpg">
										<img src="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/8_s.jpg" alt="">
									</a>
								</div>
								<div class="col-sm-4 gallery-item">
									<a href="<?php bloginfo( 'template_url' ) ?>/assets/img/gallery/9.jpg">
