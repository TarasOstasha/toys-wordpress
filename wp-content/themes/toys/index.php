            ...
            <div class="glide__track" data-glide-el="track">
                ...
                <?php 
                    $posts = get_posts( array(
                        'numberposts' => -1, // выведим все слайды, который у нас есть
                        'category_name'    => 'slide',
                        'orderby'     => 'date',
                        'order'       => 'ASC',
                        'post_type'   => 'post',
                    ...
                    // bluerex_debug($posts); // show array

                ?>
                    <?php foreach($posts as $slides) :
                        setup_postdata($slides);
                        //Type a message
                    ?>
                    <li style="background-image: url('<?php bloginfo('template_url'); ?>/assets/img/bg_1.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/about.jpg" alt="про компанию">
                        </div>
                    </div>
